...
|-------|---------|-------|--------|--------------|
| **Requirements** | Structured customer intake | (none) | `01-requirements.md` | Challenger |
| **Challenger** | Socratic stress-test of requirements | `01-requirements.md` | `02-challenges.md` | Pattern Selector |
| **Pattern Selector** | Recommends Azure AI pattern with citations | `01-requirements.md`, `02-challenges.md` | `03-pattern-decision.md` | (end of Phase 1) |

## Agent roster (Phase 2)

| Agent | Purpose |
|-------|---------|
| Architecture | Reference architecture (PoC → prod scaling) + diagram(s) rendered to PNG under `images/<mermaid-case>/` |
| Cost & Sizing | Three-scenario cost model (PoC / pilot / prod) backed by Azure Pricing MCP |
